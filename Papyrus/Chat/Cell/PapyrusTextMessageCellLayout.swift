//
//  PapyrusTextMessageCellLayout.swift
//  Papyrus
//
...
class PapyrusTextMessageCellLayout: PapyrusBaseMessageCellLayout {
    ...
    required init(chatItem: NOCChatItem, cellWidth width: CGFloat) {
        ...
        reuseIdentifier = "PapyrusTextMessageCell"
        setupAttributedText()
        setupAttributedTime()
        setupHasTail()
        setupBubbleImage()
    ...
    override func calculate() {
        ...
        let modifier = PapyrusTextLinePositionModifier()
    ...
    struct Style {
        static let fullOutgoingBubbleImage = UIImage(named: "PapyrusBubbleOutgoingFull")!
        static let highlightFullOutgoingBubbleImage = UIImage(named: "PapyrusBubbleOutgoingFullHL")!
        static let partialOutgoingBubbleImage = UIImage(named: "PapyrusBubbleOutgoingPartial")!
        static let highlightPartialOutgoingBubbleImage = UIImage(named: "PapyrusBubbleOutgoingPartialHL")!
        static let fullIncomingBubbleImage = UIImage(named: "PapyrusBubbleIncomingFull")!
        static let highlightFullIncomingBubbleImage = UIImage(named: "PapyrusBubbleIncomingFullHL")!
        static let partialIncomingBubbleImage = UIImage(named: "PapyrusBubbleIncomingPartial")!
        static let highlightPartialIncomingBubbleImage = UIImage(named: "PapyrusBubbleIncomingPartialHL")!
        ...
        static let linkColor = UIColor.init(red: 0/255.0, green: 75/255.0, blue: 173/255.0, alpha: 1)
        static let linkBackgroundColor = UIColor.init(red: 191/255.0, green: 223/255.0, blue: 254/255.0, alpha: 1)
        
        static let timeFont = UIFont.systemFont(ofSize: 12)
        static let outgoingTimeColor = UIColor.init(red: 59/255.0, green: 171/255.0, blue: 61/255.0, alpha: 1)
...
fileprivate
class PapyrusTextLinePositionModifier: NSObject, YYTextLinePositionModifier {
    ...
    fileprivate func copy(with zone: NSZone? = nil) -> Any {
        let one = PapyrusTextLinePositionModifier()
        one.font = font
